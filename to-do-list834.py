...
#Change the title
root.title("My Super Cute To Do List")
...
tasks=["Study for ISA","Finish Mech assignment","finish matlab assignment"]
...
lbl_title=tkinter.Label(root, text="To-Do-List", bg="lightpink")
lbl_title.grid(row=0,column=0)

lbl_display=tkinter.Label(root, text="", bg="lightpink")
lbl_display.grid(row=0,column=1)

txt_input=tkinter.Entry(root, width=19)
